...
public class ZeitenTable {
    ...
    private final static String _CREATE_TABLE = "CREATE TABLE " + TABLE_NAME
    ...
    private final static String _MIGRATE_TO_VERSION_2 = "ALTER TABLE " +  TABLE_NAME
            + " ADD COLUMN [pause] INTEGER NOT NULL DEFAULT 0";

    private final static String _MIGRATE_TO_VERSION_3 = "ALTER TABLE " + TABLE_NAME
