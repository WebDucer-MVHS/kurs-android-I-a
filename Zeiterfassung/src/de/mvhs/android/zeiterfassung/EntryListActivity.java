...
public class EntryListActivity extends ListActivity {
	...
	private final static String _SORT_ORDER = ZeitProvider.Columns.START
			+ " DESC";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		_Adapter = new SimpleCursorAdapter(this, // Context
				...
				new String[] { ZeitProvider.Columns.START,
						ZeitProvider.Columns.END }, // Darzustellende Spalten
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.mnu_export:
			...
			Cursor data = getContentResolver().query(ZeitProvider.CONTENT_URI,
					null, null, null, _SORT_ORDER);

			// Max setzen
			dialog.setMax(data.getCount());

			dialog.setButton(ProgressDialog.BUTTON_NEGATIVE, "Abbrechen",
