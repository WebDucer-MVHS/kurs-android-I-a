...
public class AuflistungActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		_Adapter = new SimpleCursorAdapter(
				this, // Context
				android.R.layout.simple_list_item_2, // Layout für eine Zeile
				null, // Cursor
				...
				new int[]{ // Layout IDs, in denen die Werte der Spalten angezeigt werden sollen
						android.R.id.text1,
						android.R.id.text2
					},
				SimpleCursorAdapter.FLAG_REGISTER_CONTENT_OBSERVER); // FLAG
